...
var _addModalJs = require("./js/addModal.js");
var _createMarkupJs = require("./js/createMarkup.js");
var _fruitsApiJs = require("./js/fruitsApi.js");
var _changeModalJs = require("./js/changeModal.js");
var _deleteModalJs = require("./js/deleteModal.js");

},{"./js/app.js":"8lRBv","./js/addModal.js":"6Qqds","./js/createMarkup.js":"dMjm4","./js/fruitsApi.js":"4tDM5","./js/changeModal.js":"8AaEn","./js/deleteModal.js":"fkqeI"}],"8lRBv":[function(require,module,exports) {
...
},{"./fruitsApi":"4tDM5","./createMarkup":"dMjm4"}],"4tDM5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getFruits", ()=>getFruits);
parcelHelpers.export(exports, "addFruit", ()=>addFruit);
parcelHelpers.export(exports, "changeFruit", ()=>changeFruit);
parcelHelpers.export(exports, "deleteFruit", ()=>deleteFruit);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const api_key = "669a39809ba098ed61fed14b";
(0, _axiosDefault.default).defaults.baseURL = `https://${api_key}.mockapi.io/fruits/fruits`;
const getFruits = async ()=>{
    try {
        const axiosResponse = await (0, _axiosDefault.default).get("");
...
const addFruit = async (fruit)=>{
    try {
        const addAxios = await (0, _axiosDefault.default).post("", fruit);
...
const changeFruit = async (fruit, changeID)=>{
    try {
        const updateProduct = await (0, _axiosDefault.default).put(`/${changeID}`, fruit);
...
const deleteFruit = async (fruitID)=>{
    try {
        const deleteProduct = await (0, _axiosDefault.default).delete(`/${fruitID}`);
...
},{"adfd9b103875c2dd":"7ZdpO","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7ZdpO":[function(require,module,exports) {
/*!
...
},{"8d7b0712b5ea2b3":"eVWfL","603aed6e39afb648":"bHHC0"}],"eVWfL":[function(require,module,exports) {
"use strict";
...
},{}],"bHHC0":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dMjm4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
form.addEventListener("submit", (e)=>{
    ...
    (0, _fruitsApi.addFruit)(fruit);
    (0, _fruitsApi.getFruits)();
});
addButton.addEventListener("click", (e)=>{
    addModal.classList.toggle("change__invisible");
});

},{"./fruitsApi":"4tDM5"}],"8AaEn":[function(require,module,exports) {
var _fruitsApi = require("./fruitsApi");
const changeForm = document.querySelector(".change__form");
...
},{"./fruitsApi":"4tDM5"}],"fkqeI":[function(require,module,exports) {
var _fruitsApi = require("./fruitsApi");
...
deleteForm.addEventListener("submit", (e)=>{
    ...
    (0, _fruitsApi.deleteFruit)(fruitID);
    (0, _fruitsApi.getFruits)();
});

},{"./fruitsApi":"4tDM5"}]},["farZc","8lqZg"], "8lqZg", "parcelRequire9322")
